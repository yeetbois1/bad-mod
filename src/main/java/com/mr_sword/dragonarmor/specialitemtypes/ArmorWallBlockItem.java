...
public class ArmorWallBlockItem extends ArmorItem implements Wearable {
    ...
    public ArmorWallBlockItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings, Block block, Block wallBlock) {
